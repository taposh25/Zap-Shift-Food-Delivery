...
const OurServices = () => {
    return (
      ...
      <section class=" max-w-6xl mx-auto bg-[#043C3D] py-16 px-6">
  <div class="max-w-6xl mx-auto text-center text-white">
    <h2 class="text-3xl font-bold mb-3">Our Services</h2>
  ...
  <div class="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
    ...
    {/*Card-1 */}
    <div class="bg-white hover:bg-[#C7F36B] transition-all duration-300 p-6 rounded-2xl shadow-lg cursor-pointer">
      <div class="flex justify-center mb-3">
        <img src={serviceImg} class="w-12" />
      </div>
      <h3 class="text-center text-xl font-semibold text-secondary">Express & Standard Delivery</h3>
      <p class="text-center text-neutral  mt-2">
    ...
    <div class="bg-white hover:bg-[#C7F36B] transition-all duration-300 p-6 rounded-2xl shadow-lg cursor-pointer">
      ...
      <h3 class="text-center text-xl font-semibold text-secondary">Nationwide Delivery</h3>
      <p class="text-center text-neutral  mt-2">
    ...
    <div class="bg-white hover:bg-[#C7F36B] transition-all duration-300 p-6 rounded-2xl shadow-lg cursor-pointer">
      ...
      <h3 class="text-center text-xl font-semibold text-secondary ">Fulfillment Solution</h3>
      <p class="text-center text-neutral  mt-2">
    ...
    <div class="bg-white hover:bg-[#C7F36B] transition-all duration-300 p-6 rounded-2xl shadow-lg cursor-pointer">
      ...
      <h3 class="text-center text-xl font-semibold text-secondary">Cash on Home Delivery</h3>
      <p class="text-center text-neutral  mt-2">
    ...
    <div class="bg-white hover:bg-[#C7F36B] transition-all duration-300 p-6 rounded-2xl shadow-lg cursor-pointer">
      ...
      <h3 class="text-center text-xl font-semibold text-secondary">
    ...
    <div class="bg-white hover:bg-[#C7F36B] transition-all duration-300 p-6 rounded-2xl shadow-lg cursor-pointer">
      ...
      <h3 class="text-center text-xl font-semibold text-secondary">Parcel Return</h3>
      <p class="text-center text-neutral mt-2">
